...
<header class="navbar">
            ...
            <ul class="icons">
                ...
                @php
                    ...
                    $currentFlagUrl = match ($currentLocale) {
                        'ar' => 'https://elitesoft-ai.com/wp-content/plugins/yaycurrency-pro/assets/dist/flags/eg.svg',
                        'en' => 'https://elitesoft-ai.com/wp-content/plugins/yaycurrency-pro/assets/dist/flags/us.svg',
                        default => '',
                    };
                @endphp
                                ...
                                <li>
                                    <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                                       href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        <span class="language-flag" style="background-image: url('{{ $flagUrl }}');"></span>
                                        {{ $properties['native'] }}
                                    </a>
                                </li>
                            @endif
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <div class="copyright">
                <p>&copy; 2025Bibasata. All rights reserved</p>
            </div>
        </div>
    </footer>
